...
async function importData() {
    try {
        ...
        // Import categories
        await mongoose_1.default.connection.collection('categories').insertMany(categories);
        console.log('Categories imported');
        // Import products
        await mongoose_1.default.connection.collection('products').insertMany(products);
